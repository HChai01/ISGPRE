We contructed eight datasets in this project by retrieving data from the [OCISG](http://isg.data.cvr.ac.uk/) and [Interferome](http://www.interferome.org/) databases. Here's a breakdown of them:
