Here are 395 discrete (`Original_discrete_features.zip`) and 7044 categorical features (`Occurrence_of_short_linear_sequence_patterns.zip`) we calcualted in this project.
